...
$hodNum = $year = $hodName = $faculty = $email = $contactNo = "";
...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO hod (HODNum, Year, HODName, Faculty, Email, contactno) VALUES ('$hodNum', '$year', '$hodName', '$faculty', '$email', '$contactNo')";
...
<body>
    <div class="navbar">
        ...
        <span class="navbar-brand">Add HOD</span>
        <div></div>
    </div>
        ...
        <div class="form-container">
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="hodNum" name="hodNum" required>
                </div>
                <div class="form-group">
